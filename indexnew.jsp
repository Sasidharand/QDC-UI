<%@page import="com.qdcdata.sampletest"%>
...
System.out.println(" SuccessMsg *************** 1");
    ...
    if(request.getParameter("btnview")!=null) 
    {
    	...
    	resultcnet = stmt.executeQuery("select count(*)prodid  from in_cds_prod_tmp where ProductSource='CNET' and ProductStatus='ORGN'");
    	  ...
    	  resultqpc = stmt.executeQuery("select count(*)prodid from in_cds_prod_tmp where ProductSource='QOIPR' and ProductStatus='SRC'");
    	  ...
    	  resultqdc= stmt.executeQuery("select count(*) prodid  from in_cds_prod_tmp");
	...
	<div class="container pt-3">
			...
			<div class="card bg-warning">
			    <div class="card-body text-center">
				 ...
				 <p ><a href="template5cat.jsp"><h2>View Catalogue</h2></a></p> 
			    </div>
			</div>
